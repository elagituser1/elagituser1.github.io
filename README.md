...
# Instructions to Access the Labs

## Redemption Instructions for New Users

1. Go to **Skillable**: https://lumify.learnondemand.net
2. Click **Register with Training Key**.
3. Enter the Skillable Training Key:
...
4. Complete the registration form.
   - Using your personal email address is recommended.
